...
{
    public partial class AuthorList : BaseSublayout
    {
        ...
        protected void lvAuthorList_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            ...
            if (hlAuthor != null)
            {
                ...
                hlAuthor.NavigateUrl = AuthorManager.GetAuthorUrl(author.FullName, DataSourceItem != null ? DataSourceItem : Sitecore.Context.Item);
