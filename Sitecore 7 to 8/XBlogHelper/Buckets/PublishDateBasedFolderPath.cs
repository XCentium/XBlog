        ...
        public string GetFolderPath(Database ContentDatabase, string name, ID templateId, ID newItemId, ID parentItemId, DateTime creationDateOfNewItem)
        {
            ...
            if (newItem != null)
            {
                ...
                if (!string.IsNullOrEmpty(fieldName))
                {
                    ...
                    return creationDateTime.ToString(Sitecore.Buckets.Util.BucketConfigurationSettings.BucketFolderPath, Context.Culture);
                }
                
            }

            return creationDateOfNewItem.ToString(Sitecore.Buckets.Util.BucketConfigurationSettings.BucketFolderPath, Context.Culture);
        }
    }
}
