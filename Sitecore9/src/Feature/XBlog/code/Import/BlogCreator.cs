            ...
            using (new SecurityDisabler())
            {
                ...
                try
                {
                    if (currentBlogType == BlogType.Tech.MVC)
                    {
                        ...
                        Item mvcAuthorHome = master.GetItem("/sitecore/templates/Feature/XBlog/Page/Template/Blog Author");
                        ...
                        Item mvcBlogPost = master.GetItem("/sitecore/templates/Feature/XBlog/Page/Template/Blog Post");
                        ...
                        Item mvcBlogHome = master.GetItem("/sitecore/templates/Feature/XBlog/Page/Template/Blog Home");
