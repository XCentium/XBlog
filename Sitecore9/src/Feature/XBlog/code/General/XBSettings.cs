...
namespace Sitecore.Feature.XBlog.General
{
    public sealed class XBSettings
    {
        ...
        public static string XBSearchPublishDate
        {
            get
            {
                return Settings.GetSetting("XBSearchPublishDate", "publish_date_tdt");
            }
        }
        ...
        public static string XBSearchAuthor
        {
            get
            {
        ...
        public static string XBSearchTags
        {
            get
            {
        ...
        public static string XBSearchCategory
        {
            get
            {
